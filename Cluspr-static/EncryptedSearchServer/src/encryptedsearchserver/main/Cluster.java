...
public class Cluster {
    ...
    public void writeClusterToFile(String name) throws IOException {
        ...
        //First write the name
         bw.write(name);
        //System.out.println("bw name er por"+ subIndex.keySet());
        
         bw.newLine();
        //Then write all of the sub index info
        for (String topic : subIndex.keySet()) {
            //Use string builder to save space
        	//System.out.println("Entered into for loop fow writing");
                ...
                //System.out.println("Writing skib in cluster::  "+lineSB.toString());
                bw.newLine();
        }
