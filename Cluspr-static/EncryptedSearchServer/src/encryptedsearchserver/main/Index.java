...
//                 		else exit(); TO CHECK .. IT JUST TAKES FILES
             ...
             int will_use_according_to_ratio=ratio*2; //experiment of semi dynamic when I use very small amount of data.. 
...
//                 		else exit(); TO CHECK .. IT JUST TAKES FILES
             ...
             //save into a FILE
             //execute it just for first time.
             boolean fla=true;
             if (fla==true)
             {
             String Fname= "/home/c00300901/eclipse-workspace/S3BD-JasonThesis/cloud/cloudserver/utilities/topics.txt";
 ...
 // 1st stage is correct. Now go to 2nd stage
     ...
     /*        DecimalFormat df4 = new DecimalFormat(".###");
            ...
            // PrintWriter writer = null;
             try {
            	 PrintWriter  writer = new PrintWriter("/home/c00300901/eclipse-workspace/S3BD-JasonThesis/cloud/cloudserver/utilities/deneme.txt", "UTF-8");
                 C.print( writer,2,2);
                 writer.close();
