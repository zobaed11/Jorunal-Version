   ...
   long startTime;
    ...
    public EncryptedSearchServer(String[] args) {
        ...
        switch(args[0]) {
            ...
            case "-p":
                ...
                System.out.println("Total elapsed time:"+ Double.toString(totalTime));
                break;
            case "-a":
                sendAbstracts();
            default:
    ...
    private void partition() {
       ...
       // Partitioner part = new Partitioner(index);
        ...
        Partitioner_mine part = new Partitioner_mine(index);
    ...
    private void sendAbstracts() {
        ...
        //part.setNumberOfClusters(65); // index.getNumberOf 
        part.setNumberOfClusters(index.getNumberOfCluster());
