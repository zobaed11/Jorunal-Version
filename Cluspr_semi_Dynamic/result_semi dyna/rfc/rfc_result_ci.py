...
rects2 = ax.bar(ind[4], value_200, 0.2, bottom=0, yerr=std_200, align='center', alpha=.8, color='white',edgecolor="black",hatch= "\\\\\\",capsize=5)  
rects2 = ax.bar(ind[4] + 0.250, value_avg_bar2, 0.2, bottom=0, yerr=std_avg_bar2, align='center', alpha=.8, color='white',edgecolor="salmon",hatch= "////",capsize=5)
...
ax.legend(bbox_to_anchor=(.65, .99), loc=2, borderaxespad=0., fontsize=18)




plt.savefig('/home/zobaed/Dropbox/semantic search-sailish/publication/new_Journal-Zobaed/Figure/semiDynamic_coherence_rfc_ci.pdf',bbox_inches='tight')
plt.show()