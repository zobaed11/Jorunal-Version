...
'''
DELETED seed0, seed1, .... manually from result file. Result file is the copy of the output from my_evaluation
...
ax.legend(bbox_to_anchor=(.71, .99), loc=2, borderaxespad=0., fontsize=14)


fig.savefig('/home/c00300901/Dropbox/semantic search-sailish/publication/new_Journal-Zobaed/Figure/semiDynamic_coherence_rfc.pdf')
plt.show()