...
avg_bar2  = [0.15476607, 0.15253, .16234, .167324, .15383]
...
avg_bar3  = [.14234, .152213, .14932, .14863, .15121]
...
ax.legend(bbox_to_anchor=(.60, .98), loc=2, borderaxespad=0., fontsize=18)

plt.yticks(fontsize=20)
fig.savefig('/home/zobaed/Dropbox/semantic search-sailish/publication/new_Journal-Zobaed/Figure/semiDynamic_coherence_bbc_ci.pdf',bbox_inches='tight')
plt.show()