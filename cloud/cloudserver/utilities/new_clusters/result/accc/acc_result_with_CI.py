...
#rects2 = ax.bar(ind[0] + 0.25, value_25+np.abs(df_25.values.min()), 0.15,bottom=df_25.values.min(), yerr=std_25, align='center', alpha=.8, color='pink',edgecolor="black",hatch= "\\\\",label= "SDCS",capsize=5 ) 
#
#
...
#rects2 = ax.bar(ind[1] + 0.25, value_50+np.abs(df_50.values.min()), 0.15, bottom=df_50.values.min(), yerr=std_50, align='center', alpha=.8, color='pink',edgecolor="black",hatch= "\\\\",capsize=5)
#
...
#rects2 = ax.bar(ind[2] + 0.25, value_avg_bar1+np.abs(df_avg_bar1.values.min()), 0.15, bottom=df_avg_bar1.values.min(), yerr=std_avg_bar1, align='center', alpha=.8, color='pink',edgecolor="black",hatch= "\\\\",capsize=5)
#
...
#rects2 = ax.bar(ind[3]+.25, value_20+np.abs(df_20.values.min()), 0.15, bottom=df_20.values.min(), yerr=std_20, align='center', alpha=.8, color='pink',edgecolor="black",hatch= "\\\\",capsize=5) 
#
#
...
#rects2 = ax.bar(ind[4] + 0.250, value_avg_bar2+np.abs(df_avg_bar2.values.min()), 0.15, bottom=df_avg_bar2.values.min(), yerr=std_avg_bar2, align='center', alpha=.8, color='pink',edgecolor="black",hatch= "\\\\",capsize=5)
...
fig.savefig('/home/c00300901/Dropbox/semantic search-sailish/publication/new_Journal-Zobaed/Figure/semiDynamic_coherence_accc_ci.pdf')
plt.show()
